...
sentences, labels = loadData('Pretrained_Data.csv')
...
pickle.dump(model, open(path + 'model_'+sys.argv[1]+'.sav', 'wb'))
pickle.dump(tokenizer, open(path + 'tokenizer_'+sys.argv[1]+'.sav', 'wb'))
